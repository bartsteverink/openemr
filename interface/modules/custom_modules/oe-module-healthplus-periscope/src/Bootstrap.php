...
use OpenEMR\Modules\HealthplusPeriscope\CustomSkeletonRestController;


class Bootstrap
{
    const MODULE_INSTALLATION_PATH = "/interface/modules/custom_modules/";
    const MODULE_NAME = "oe-module-healthplus-periscope";
    /**
    ...
    public function addGlobalSettingsSection(GlobalsInitializedEvent $event)
    {
        ...
        $section = xlt("Healthplus.ai | PERISCOPE");
    ...
    public function addCustomModuleMenuItem(MenuEvent $event)
    {
        ...
        $menuItem->label = xlt("Healthplus | PERISCOPE");
        ...
        $menuItem->url = "/interface/modules/custom_modules/oe-module-healthplus-periscope/public/sample-index.php";
        $menuItem->children = [];
    ...
    {
        $this->eventDispatcher->addListener(pRenderEvent::EVENT_SECTION_LIST_RENDER_AFTER, [$this, 'renderPeriscopeCard']);
    }    

    public function renderPeriscopeCard(pRenderEvent $event)
    {
        // $pid = $event->getPid();
